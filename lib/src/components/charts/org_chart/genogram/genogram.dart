...
import 'genogram_controller.dart';
...
class GenaiGenogram<E> extends BaseGraph<E> {
  ...
  GenaiGenogram({
    ...
    // required GenaiGenogramController<E> super.controller,
...
class GenogramState<E> extends BaseGraphState<E, GenaiGenogram<E>> {
  ...
  @override
  GenaiGenogramController<E> get controller =>
      widget.controller as GenaiGenogramController<E>;
}
