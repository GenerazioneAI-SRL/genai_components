...
class GenaiOrgChartController<E> extends GenaiBaseGraphController<E>
  ...
  GenaiOrgChartController({
    ...
    // Calculate positions without centering (center requires viewport size)
    calculatePosition(center: false);
  }
