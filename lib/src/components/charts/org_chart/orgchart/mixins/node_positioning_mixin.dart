...
/// Mixin for node positioning utilities for GenaiOrgChartController
mixin NodePositioningMixin<E> {
  ...
  double _positionLeafNodesTopToBottom(
    ...
    if (this is GenaiOrgChartController<E>) {
      leafColumns = (this as GenaiOrgChartController<E>).leafColumns;
    }
