...
import 'package:genai_components/src/vendor/fl_nodes/src/widgets/improved_listener.dart';
import 'package:genai_components/src/vendor/fl_nodes/src/widgets/node_editor_render_object.dart';
...
class _NodeEditorDataLayerState extends State<NodeEditorDataLayer> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return controlsWrapper(
      RepaintBoundary(
        child: ShaderBuilder(
          assetKey: 'packages/genai_components/src/vendor/fl_nodes/shaders/grid.frag',
