...
class PagedDataTableThemeData extends Equatable {
  ...
  List<Object?> get props => [
        ...
        filtersHeaderBackgroundColor,
        footerBackgroundColor,
        rowColors,
        textStyle,
        rowsTextStyle,
        headerTextStyle,
        filtersHeaderTextStyle,
        footerTextStyle,
        chipTheme,
        border,
        dividerColor,
...
class PagedDataTableConfiguration extends Equatable {
  ...
  @override
  List<Object?> get props => [pageSizes, columnsHeaderHeight, filterBarHeight, rowHeight, initialPageSize, footer];
}
...
class PagedDataTableFooterConfiguration extends Equatable {
  ...
  const PagedDataTableFooterConfiguration({this.showTotalElements = false, this.footerVisible = true});
