  ...
  Widget build(BuildContext context) {
    ...
    final card = Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: color.withValues(alpha: theme.opacityStrong), width: 1),
        gradient: LinearGradient(
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
          colors: [
            color.withValues(alpha: compact ? 0.08 : 0.10),
            color.withValues(alpha: compact ? theme.opacityFaint : theme.opacitySubtle),
          ],
        ),
      ),
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: color.withValues(alpha: theme.opacityMuted),
