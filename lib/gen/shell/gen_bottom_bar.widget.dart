...
/// legata alle destinations nav. Usata via [GenBottomBar.items] / shell
...
///   AI, profilo, ricerca].
class GenBottomBar extends StatelessWidget {
  const GenBottomBar({
    super.key,
  ...
  final ValueChanged<GenDestination> onOpenGroup;
  final VoidCallback onOverflow;
  final int maxItems;

  /// Se non null → modalità custom: queste voci sostituiscono la barra nav.
  final List<GenBottomBarItem>? items;
