...
class GenContainer extends StatefulWidget {
  const GenContainer({
    super.key,
    required this.child,
    this.title,
  ...
  /// Superficie "incassata": background [GenTokens.primaryBackground] e NESSUNA
  ...
  @override
  State<GenContainer> createState() => _GenContainerState();
}

class _GenContainerState extends State<GenContainer> {
  @override
  Widget build(BuildContext context) {
    ...
    final br =
        widget.borderRadius ?? BorderRadius.circular(widget.recessed ? GenSizes.radiusSurface : GenSizes.radiusCard);
      ...
      child: ClipRRect(
        ...
        child: Column(
          ...
          children: [
              ...
              Container(
                ...
                child: Padding(
                  padding: widget.plainHeader
                      ? const EdgeInsets.fromLTRB(GenSizes.gapLg, GenSizes.gapLg, GenSizes.gapLg, 0)
                      : const EdgeInsets.symmetric(horizontal: GenSizes.gapLg, vertical: GenSizes.gapMd),
                  child: Row(
                    ...
                    children: [
                      ...
                      if (widget.actionTitle != null && widget.onActionTap != null && widget.actionWidget == null)
                        SizedBox(
                          height: 20,
                          child: ShadButton.ghost(onPressed: widget.onActionTap!, child: Text(widget.actionTitle!)),
                        ),
            ...
            Flexible(
              child: Padding(
                padding: widget.contentPadding ?? const EdgeInsets.all(GenSizes.gapLg),
                child: widget.child,
              ),
            ),
          ],
    ...
    if (hasTitle && widget.externalTitle) {
      final Widget? action =
          ...
          (widget.actionTitle != null && widget.onActionTap != null
              ? ShadButton.ghost(onPressed: widget.onActionTap!, child: Text(widget.actionTitle!))
              : null);
      return Column(
        ...
        children: [
          ...
          Row(
            children: [
              if (widget.titleIcon != null) ...[widget.titleIcon!, const SizedBox(width: GenSizes.gapSm)],
              Expanded(
