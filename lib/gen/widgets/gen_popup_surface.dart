...
///
/// [kGenModalScrim]: modal surfaces (dialogs, sheets) — black @ 45%.
/// [kGenPopoverScrim]: anchored popovers (menus, dropdown overlays) — light.
const Color kGenModalScrim = Color(0x73000000); // Colors.black, alpha 0.45
const Color kGenPopoverScrim = Colors.black12;
...
class GenPopupSurface extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<GenPopupSurface> createState() => _GenPopupSurfaceState();
}

class _GenPopupSurfaceState extends State<GenPopupSurface> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant GenPopupSurface oldWidget) {
