  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(
          horizontal: GenTokens.of(context).gapLg,
          vertical: GenTokens.of(context).gapMd),
      width: width,
      child: Align(
        alignment:
    ...
    return Container(
      ...
      child: isLoading
          ? Padding(
              ...
              child: Center(
                child: SizedBox(
                  width: GenSizes.iconSizeLarge,
                  height: GenSizes.iconSizeLarge,
...
class _SwipeActionsRevealState<TResultId extends Comparable,
  ...
  Widget _revealTile(GenTokens theme, TableAction<TResult> a) {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (a.label != null) ...[
              const SizedBox(height: GenSizes.gapXs),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: GenSizes.gapXs),
                child: Text(
                  a.label!,
                  maxLines: 1,
