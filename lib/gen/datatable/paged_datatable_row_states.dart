            ...
            children: [
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: Align(
                      ...
                      child: GenShimmer(width: 18, height: 18, borderRadius: GenSizes.radiusChip),
                    ),
                  ),
                ),
              ...List.generate(state.columns.length, (colIndex) {
                ...
                return Expanded(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: GenSizes.gapLg, vertical: GenSizes.verticalPadding),
                    child: Align(
                      alignment: Alignment.centerLeft,
                      child: GenShimmer(
...
class _EmptyState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TweenAnimationBuilder<double>(
      ...
      child: Container(
        padding: const EdgeInsets.symmetric(vertical: GenSizes.padding * 3, horizontal: GenSizes.padding),
        child: Column(
...
class _ErrorState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TweenAnimationBuilder<double>(
      ...
      child: Container(
        padding: const EdgeInsets.symmetric(vertical: GenSizes.padding * 2, horizontal: GenSizes.padding),
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Container(
